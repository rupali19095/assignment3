...
public class ListSavedDataGPS extends AppCompatActivity {
    DatabaseHelper_gps db1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_saved_data_gps);
    ...
    public void export(View v) {
        ...
        try {
            FileOutputStream out = openFileOutput("data_gps.csv", Context.MODE_PRIVATE);
            out.write((export_list.toString()).getBytes());

            Context context = getApplicationContext();
            File filelocation = new File(getFilesDir(), "data_gps.csv");
