...
public class Accelerometer extends AppCompatActivity implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if ((currentTime - lastTime) > 5000) {
            ...
            if(xValue.getText()!=""&&yValue.getText()!=""&&zValue.getText()!=""){
                AddData();
            }
        }
    ...
    public void AddData() {
        String save_x = xValue.getText().toString();
        String save_y = yValue.getText().toString();
        String save_z = zValue.getText().toString();
